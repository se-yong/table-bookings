...
from .views.reviews import ReviewCreateView, ReviewHistoryView, ReviewUpdateView, ReviewDeleteView
...
urlpatterns = [
    ...
    path('restaurant/<int:restaurant_id>/seat/<int:seat_id>', RestaurantBookingView.as_view(),
